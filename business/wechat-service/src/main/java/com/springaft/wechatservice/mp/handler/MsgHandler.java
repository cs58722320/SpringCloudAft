package com.springaft.wechatservice.mp.handler;
...
public class MsgHandler extends AbstractHandler {
	...
	public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context, WxMpService weixinService,
        ...
        textBuilder.fromUser(wxMessage.getToUser());
        System.out.println(textBuilder.content(fromContent).build().toString());

        return textBuilder.content(fromContent).build();
	}
